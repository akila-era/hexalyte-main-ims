...
const pageRoutes = require('./v1/page.route')
const deliveryPartnerRoutes = require('./v1/deliverypartner.route')
const newOrderRoutes = require('./v1/neworder.route')
const newOrderItemsRoutes = require('./v1/neworderitems.route')
const orderSourceRoutes = require('./v1/ordersource.route')

const subProductRoutes = require('./v1/subproduct.route')
const trackingNumberRoutes = require('./v1/trackingnumber.route')
const orderStatusRoutes = require('./v1/orderStatus.route')
...
const routeManager = (app) => {
    ...
    app.use('/v1/deliverypartner', deliveryPartnerRoutes)
    app.use('/v1/neworder', newOrderRoutes)
    app.use('/v1/neworderitems', newOrderItemsRoutes)
    app.use('/v1/ordersource', orderSourceRoutes)
    app.use('/v1/subproducts', subProductRoutes)
    app.use('/v1/trackingnumbers', trackingNumberRoutes)
    app.use('/v1/orderstatus', orderStatusRoutes)
}
