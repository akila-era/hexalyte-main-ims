...
router
  ...
  .post(
    auth(),
    validate(customerAddressValidation.addCustomerAddress),
...
router
  ...
  .get(
    auth(),
    validate(customerAddressValidation.getCustomerAddressById),
    customerAddressController.getCustomerAddressById
  )
  .put(
    auth(),
    validate(customerAddressValidation.updateCustomerAddressById),
    customerAddressController.updateCustomerAddressById
  )
  .delete(
    auth(),
    validate(customerAddressValidation.deleteCustomerAddressById),
